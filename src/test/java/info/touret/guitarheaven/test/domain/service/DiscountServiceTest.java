...
class DiscountServiceTest {
    ...
    void should_return_0() {
        ...
        assertEquals(0, discountService.getDiscount(new Guitar(1L, UUID.randomUUID(), "Fender", Guitar.TYPE.ELECTRIC, 1000d, 10)));
    }
    ...
    void should_return_half_of_the_difference() {
        ...
        assertEquals(50, discountService.getDiscount(new Guitar(1L, UUID.randomUUID(), "Fender", Guitar.TYPE.ELECTRIC, 1000d, 10)));
    }
